...
Use this resource to configure an AWS GovCloud CloudTrail integration analyze CloudTrail activity for monitoring cloud account security.
...
A Lacework AWS GovCloud CloudTrail integration can be imported using a `INT_GUID`, e.g.

```
$ terraform import lacework_integration_aws_govcloud_ct.account_abc EXAMPLE_1234BAE1E42182964D23973F44CFEA3C4AB63B99E9A1EC5
```
